...
from accounts.api_endpoints.Profile.ProfileDelete.views import ProfileDeleteAPIView
from accounts.api_endpoints.Profile.PasswordReset.views import  PasswordResetRequestAPIView, PasswordResetConfirmAPIView
from accounts.api_endpoints.Profile.ProfileUpdate import ProfileUpdateAPIView 
