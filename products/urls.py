...
urlpatterns = [
    ...
    path('productvariants/<str:slug>/', CategoryRetrieveAPIView.as_view(), name="productvariants-retrieve"),
    path('mediafiles/<str:slug>/', CategoryRetrieveAPIView.as_view(), name="mediafiles-retrieve"),
    path('colors/<str:slug>/', CategoryRetrieveAPIView.as_view(), name="colors-retrieve"),
    path('brand/<str:slug>/', CategoryRetrieveAPIView.as_view(), name="brand-retrieve"),
    path('size/<str:slug>/', CategoryRetrieveAPIView.as_view(), name="size-retrieve"),
